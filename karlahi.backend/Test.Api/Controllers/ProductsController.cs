...
namespace Test.Api.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        {
            _logger.LogInformation("Get() executed without cache");
            var product = await _productsService.GetBySpecAsync(new ProductByIdSpecification(id));
            if (product != null)
        ...
        {
            await _productsService.RemoveBySpecAsync(new ProductByIdSpecification(id));
        }
    }
}
